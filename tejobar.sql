...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-12-2025 a las 03:13:32
...
INSERT INTO `apartados` (`idApartado`, `idPersona`, `idProducto`, `cantidad`, `fechaApartado`, `estado`) VALUES
(2, 109, 1, 1, '2025-12-08 23:47:19', 'pendiente');
...
CREATE TABLE `cancha` (
  ...
  `estado` enum('ACTIVAS','MANTENIMIENTO','NO_ACTIVA','PENDIENTE') DEFAULT NULL,
...
(1, 'ACTIVAS', 'Disponible'),
(2, 'PENDIENTE', 'Disponible');
...
INSERT INTO `equipo` (`idEquipo`, `nombreEquipo`, `cupos_disponibles`, `id_capitan`) VALUES
(1, 'Equipo A', NULL, NULL),
(2, 'Equipo B', NULL, NULL),
(3, 'Equipo C', NULL, NULL);
...
INSERT INTO `jugador` (`idPersona`, `estado`, `rut`, `id_equipo`) VALUES
(101, 1, 'RUT101', NULL),
(102, 1, 'RUT102', NULL),
(103, 1, 'RUT103', NULL),
(105, 1, 'RUT105', NULL),
...
(107, 'Admin', 'admin12@gmail.com', '$2a$10$Z0QfXW2o7rCymPcdS/xqcOJ1KZNihVXRM0OxQ0wEjCOKT6rkeen3m', '0000000000', 'admin'),
(108, 'Kevin', 'saaa@gmail.com', '$2a$10$ILOADwu2InS8qsiMW2HhkeGR/Mb/jtTn5.6xV5ch/caqfxVob0gBy', '1214214', 'jugador'),
(109, 'Sam', 'andrescastrop124@gmail.com', '$2a$10$X2KgCcZbiZe3jxblE.DNYesFZrLCfCyRx4gjfTJA6sHZuxXJT8q2S', '1214214', 'jugador');
...
(1, 'CERVEZA ARTESANAL', 9680, 50, '2025-12-15', 'cerveza.jpg'),
...
ALTER TABLE `equipo`
  ...
  ADD UNIQUE KEY `UKke7oey4kceofmrnc0t2gmrytj` (`id_capitan`);
...
ALTER TABLE `partido`
  ...
  ADD KEY `FKjvrmpn4bctpud058lubn0ddmj` (`cancha`);
...
--
ALTER TABLE `apartados`
  MODIFY `idApartado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `persona`
  MODIFY `idPersona` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
...
--
ALTER TABLE `equipo`
  ADD CONSTRAINT `FKti4yjt7o53ki21lpnlfcrl6ua` FOREIGN KEY (`id_capitan`) REFERENCES `jugador` (`idPersona`);

--
-- Filtros para la tabla `jugador`
--
ALTER TABLE `jugador`
  ADD CONSTRAINT `FKi60lqb7emposedyui33q42u1i` FOREIGN KEY (`id_equipo`) REFERENCES `equipo` (`idEquipo`),
...
--
ALTER TABLE `partido`
  ADD CONSTRAINT `FKjvrmpn4bctpud058lubn0ddmj` FOREIGN KEY (`cancha`) REFERENCES `cancha` (`idCancha`);
